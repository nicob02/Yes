...
class Simulator(nn.Module):
    ...
    def forward(self, graph:Data, **argv):
        ...
        v = predicted_tmp[:, :self.ndim] + graph_last.x[:, :self.ndim] # U add for all nodes to the first two columns(Values in t)  and update them, getting two consecutive time steps. 
