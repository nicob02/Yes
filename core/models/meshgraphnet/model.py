...
class GnBlock(nn.Module):
    ...
    def __init__(self, hidden_size=128):
        ...
        nb_custom_func = build_mlp(2*hidden_size, hidden_size, hidden_size)    // 2 because of previos + new aggregated edges info   
    ...
    def forward(self, graph):
        ...
        graph.x += node_attr        // graph.x contains new node attribute, so u add it to the preious one u cloned
